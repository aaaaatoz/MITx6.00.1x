...
WORDLIST_FILENAME = "C:/Users/Administrator/Downloads/ProblemSet4/ProblemSet4/words.txt"
...
def getWordScore(word, n):
    ...
    result = len(word) * result
    
    if len(word) == n : result += 50
...
def isValidWord(word, hand, wordList):
    ...
    """
    validFlag = True
    if not word or word not in wordList:
        validFlag = False
    else:
    ...
    while sum(hand.values()) > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                #sample "fast" earned 28 points. Total: 46 points.
                score = getWordScore(inputword,n)
                total_score += score
                print "%s earned %d points, Total: %d points" %(inputword,score,total_score)
                print
                # Update the hand
